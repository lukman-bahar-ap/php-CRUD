...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		if(ScreenX<=494)
		{
			varColumnDefs = [{className: 'never', targets: [0]}, {className: 'none', targets: [0,-1]}];
			varTinggi = 130;
			varaoColumns = [
								{ bVisible:false },
							   null,
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-master-data/pasien_json.php",		
		...
		$('#btnUbah').on('click', function () {
			  ...
			  opUrl = 'pasien_add.php?reqMode=update&reqId='+anSelectedId+'&reqDevice='+anDevice;		
		...
		$('#btnPeriksa').on('click', function () {
			 ...
			 // parent.frames['mainFramePop'].location.href = 'arsip_add_identitas_pribadi_monitoring.php?reqId=' + data[0];
			  window.top.displayUrlFromIframeChild('../master-data/periksa.php?reqMode=update&reqId='+anSelectedId+'&reqNama='+anSelectedNama+'&reqDevice='+anDevice);
		});
		...
		$('#btnHapus').on('click', function () {
			...
			else
			{
				$.messager.confirm('Warning', 'Apakah Anda yakin ingin menghapus data ini?', function(r){
					if (r){
						$.getJSON("../json-master-data/delete.php?reqMode=pasien&id="+anSelectedId,
				  function(data){
		...
		$('#btnExpor').on('click', function () {
			newWindow = window.open("report_pasien_excel.php?reqIdPelangganKontrak=<?=$reqIdPelangganKontrak?>&reqPelangganKontrak=<?=$reqPelangganKontrak?>", "Cetak");
			newWindow.focus();
		});					
...
function Tambah(){
	...
	opUrl = 'pasien_add.php?reqMode=insert&reqDevice='+anDevice;		
	window.parent.OpenDHTML(opUrl, '<?=titleWeb()?>', widthPopup, heightPopup, topPopup);		
}
</script> 
...
<div id="wadah">
 	 ...
 	 <div class="container">
    	<ol class="breadcrumb">
        	<li class="active">&nbsp;&nbsp;&nbsp;&nbsp;
            	<i class="fa fa-columns"></i>&nbsp;&nbsp;Data Pasien
          	</li>
      	</ol>
  	</div>
    <div class="panel-heading">
      <i class="fa fa-external-link-square"></i>
          ...
          &nbsp;&nbsp;&nbsp;-->
          <a href="#!" id="btnPeriksa" title="Periksa Pasien"><img src="../main/images/btn-check.png" width="15" height="15"/> Check Up</a>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <a href="#!" id="btnTambah" onClick="Tambah();" title="Add"><img src="../main/images/btn-tambah.png" width="15" height="15"/> Pasien Baru</a>
          &nbsp;&nbsp;&nbsp;
          <?
            if($userLogin->unitUpj == "Super Admin")
            {
          ?>
          <a href="#!" id="btnUbah" title="Update"><img src="../main/images/btn-ubah.png" width="15" height="15"/> Ubah</a>
          &nbsp;&nbsp;&nbsp;
