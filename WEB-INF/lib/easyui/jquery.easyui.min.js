...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"",invalidMessage:null,rules:{email:{validator:function(_39c){
...
var _70c=$("<input type=\"text\" class=\"combo-text\" style=\"text-align:center; width:96px; color:#000;\">").appendTo(span);
...
if(!_7d3.spinner){
var p=$("<div style=\"padding:2px\"><input style=\"width:50px\"></div>").insertAfter(_7d5.children("div.datebox-calendar-inner"));
