...
drilldownmenu.prototype.buildmenu=function($){
	...
	this.$uls.each(function(i){ //loop through each UL
		...
		if (i==0){ //if topmost UL
			$('<li class="backcontroltitle" style="text-align:left;">Menu Utama</li>').prependTo($thisul).click(function(e){e.preventDefault()})
			...
			$('<li class="backcontrol" style="text-align:left;"><img src="'+thisdrill.backarrow+'" style="border-width:0" /> Menu Utama</li>') //add back LI item
