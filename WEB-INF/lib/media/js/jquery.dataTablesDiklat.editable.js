        ...
        */
        ...
        return this.each(function () {
            ...
            if (oAddDeleteToolbar.length != 0) {
				...
				oAddDeleteToolbar.append("&nbsp;&nbsp;&nbsp;Tampil Berdasarkan Diklat <select id='tahun'><option value=''>Semua</option></select>"); 
				oSifatRowSelect = $("#tahun");
				$.getJSON("../json/diklat_json.php",
				function(data){
				...
				oSifatRowSelect.change(function () { 
					...
					fnReloadAjax('../json/daftar_pegawai_diklat_perjenjangan_json.php?reqDiklat=' + $("#tahun").val() + '&reqId=' + properties.pSatkerId);		
