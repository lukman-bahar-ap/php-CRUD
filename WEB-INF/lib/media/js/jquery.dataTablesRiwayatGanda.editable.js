        ...
        */
        ...
        return this.each(function () {
            ...
            if (oAddDeleteToolbar.length != 0) {
				...
				oAddDeleteToolbar.append("&nbsp;&nbsp;&nbsp;Tampil Berdasarkan <select id='bulan'><option value=''>Semua Data</option><option value='PANGKAT'>Riwayat Pangkat</option><option value='JABATAN'>Riwayat Jabatan</option><option value='GAJI'>Riwayat Gaji</option></select>");	
				oBulanRowSelect = $("#bulan");
				
				oBulanRowSelect.change(function () { 
					fnReloadAjax('../json/tools_cek_riwayat_ganda_json.php?reqMode=' + $("#bulan").val());							
				});
				
				/* oAddDeleteToolbar.append("&nbsp;&nbsp;&nbsp;Tampil Berdasarkan Agama <select id='tahun'><option value=''>Semua</option></select>"); 
				oSifatRowSelect = $("#tahun");
				$.getJSON("../json/agama_json.php",
				function(data){
				...
				oSifatRowSelect.change(function () { 
					...
					fnReloadAjax('../json/daftar_pegawai_agama_json.php?reqAgamaId=' + $("#tahun").val() + '&reqId=' + properties.pSatkerId);		
