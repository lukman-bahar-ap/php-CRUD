...
//			alert(mySplitResult[6]+'--');
		...
		function _fnOnRowPilihArsipHapus(event) {
			...
			window.self.location.href = 'pilih_hapus_arsip_simpan.php?reqCurrArsipId='+ sData;
		}
        ...
        */
        ...
        return this.each(function () {
            ...
            if (oAddDeleteToolbar.length != 0) {
				...
				oAddDeleteToolbar.append("&nbsp;&nbsp;&nbsp;Tampil Berdasarkan Sifat <select id='bulan'><option value=''>Semua Data</option><option value='SUSUT'>SUSUT</option><option value='SERAHKAN'>SERAHKAN</option><option value='MUSNAH'>MUSNAH</option></select>");
				oBulanRowSelect = $("#bulan");
				
				oBulanRowSelect.change(function () { 
					//alert($("#pilihan").val());	
					/* Example call to load a new file */
					fnReloadAjax('../json/hapus-json.php?reqMode=' + $("#bulan").val());		
