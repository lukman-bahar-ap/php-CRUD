        ...
        */
        ...
        return this.each(function () {
            ...
            if (oAddDeleteToolbar.length != 0) {
				...
				oAddDeleteToolbar.append("&nbsp;&nbsp;&nbsp;Tampil Berdasarkan Jabatan <select id='tahun'><option value=''>Semua</option><option value='1'>Eselon I</option><option value='2'>Eselon II</option><option value='3'>Eselon III</option><option value='4'>Eselon IV</option><option value='5'>Eselon V</option></select>"); 
				...
				oSifatRowSelect.change(function () { 
					...
					fnReloadAjax('../json/daftar_pegawai_jabatan_json.php?reqEselonId=' + $("#tahun").val() + '&reqId=' + properties.pSatkerId);		
