    ...
    $.fn.makeEditable = function (options) {
		...
		*/
        ...
        function _fnOnRowBaca(event) {
			...
			opWidth = 1050;
			opHeight = 550;
			opUrl    = 'pop_entry_surat_masuk.php?reqJsonId='+id;
        ...
        */
        ...
        return this.each(function () {
			...
			oAddDeleteToolbar.append("&nbsp;&nbsp;&nbsp;Filter <select id='filter'><option value='satker'>Satker Terpilih</option><option value='all'>Semua Satker</option></select>");	
			oTahunRowSelect = $("#filter");
			...
			oTahunRowSelect.change(function () { 
				...
				fnReloadAjax('../json/anjab_kandidat_json.php?reqMode=' + $("#filter").val() + '&reqSatkerId=' + properties.pSatkerId);
			});
