        ...
        */
        ...
        return this.each(function () {
            ...
            if (oAddDeleteToolbar.length != 0) {
				...
				oAddDeleteToolbar.append("&nbsp;&nbsp;&nbsp;Tampil Berdasarkan Sifat <select id='tahun'><option value=''>Semua Data</option></select>"); 
				oSifatRowSelect = $("#tahun");
				$.getJSON("../json/sifat-json.php",
				function(data){
					for(i=0;i<data.SIFAT_ID.length; i++)
					{
					$("<option value='" + data.SIFAT_ID[i] + "'>" + data.SIFAT_NAMA[i] + "</option>").appendTo("#tahun"); 
					} 
				});
				oSifatRowSelect.change(function () { 
					//alert($("#pilihan").val());	
					/* Example call to load a new file */
					fnReloadAjax('../json/katalog-json.php?reqMode=' + $("#tahun").val());		
