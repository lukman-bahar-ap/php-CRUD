    ...
    $.fn.makeEditable = function (options) {
		...
		*/
		...
		function _fnOnRowEditArsip(event) {
			...
			opWidth = 1050;
			opHeight = 550;
			//alert(properties.pAttributCode);
        ...
        */
        ...
        return this.each(function () {
            ...
            if (oAddDeleteToolbar.length != 0) {
     			oAddDeleteToolbar.append("&nbsp;&nbsp;&nbsp;Status Pegawai <select id='filter'><option value='AND STATUS_PEGAWAI = 0'>Usulan</option><option value='AND (STATUS_PEGAWAI = 1 OR STATUS_PEGAWAI = 2)' selected='selected'>CPNS / PNS</option><option value='AND STATUS_PEGAWAI = 1'>CPNS</option><option value='AND STATUS_PEGAWAI = 2'>PNS</option><option value='AND STATUS_PEGAWAI = 3'>Pensiun</option><option value='AND STATUS_PEGAWAI = 4'>TNI</option><option value='AND (STATUS_PEGAWAI = 5 OR STATUS_PEGAWAI = 6)'>Tewas / Wafat</option><option value='AND STATUS_PEGAWAI = 7'>Pindah</option><option value='AND STATUS_PEGAWAI = 8'>Diberhentikan</option></select>");	
				oFilterRowSelect = $("#filter");
							
				oFilterRowSelect.change(function () { 
					/* Example call to load a new file */
					fnReloadAjax('../json/pegawai_json.php?reqSearch=' + $("#filter").val() + '&reqId=' + properties.pSatkerId);
				});
            }
