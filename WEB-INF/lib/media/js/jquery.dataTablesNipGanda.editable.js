        ...
        */
        ...
        return this.each(function () {
            ...
            if (oAddDeleteToolbar.length != 0) {
				...
				oAddDeleteToolbar.append("&nbsp;&nbsp;&nbsp;Tampil Berdasarkan <select id='bulan'><option value=''>Semua Data</option><option value='LAMA'>NIP LAMA</option><option value='BARU'>NIP BARU</option></select>");	
				oBulanRowSelect = $("#bulan");
				
				oBulanRowSelect.change(function () { 
					fnReloadAjax('../json/tools_cek_nip_ganda_json.php?reqMode=' + $("#bulan").val());							
				});
