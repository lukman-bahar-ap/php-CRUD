<?php
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,xls,doc,pdf";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,xls,doc,pdf";
