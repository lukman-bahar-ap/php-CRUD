...
include_once("../WEB-INF/classes/base/UserKontrakLogin.php");
  ...
  class UserLoginPelangganKontrakAndroid{
    /* Properties */
    ...
    /******************** CONSTRUCTOR **************************************/
    function UserLoginPelangganKontrakAndroid(){
    ...
    function setProps(){
		...
		$this->idKontrak = $_SESSION["ssUsr_IdKontrak"];
    ...
    function verifyUserLogin($usrLogin,$password){			
		...
		if($usr->firstRow()){
			...
			$_SESSION["ssUsr_UID"] = $usr->getField("USER_KONTRAK_LOGIN_ID");
			$_SESSION["ssUsr_IdKontrak"] = $usr->getField("PELANGGAN_KONTRAK_ID");
			$_SESSION["ssUsr_idUser"] = $usr->getField("TELEPON");
	...
	function retrieveUserInfo(){
		...
		if ($usr->firstRow()) {
			...
			$this->IdKontrak = $usr->getField("PELANGGAN_KONTRAK_ID");
  ...
  $UserLoginPelangganKontrakAndroid = new UserLoginPelangganKontrakAndroid();
