...
include_once("../WEB-INF/classes/base/PelangganBebas.php");

  class UserLoginPelangganBebas{
    /* Properties */
    ...
    /******************** CONSTRUCTOR **************************************/
    function UserLoginPelangganBebas(){
    ...
    function verifyUserLogin($usrLogin,$password){			
		...
		if($usr->firstRow()){
			...
			$_SESSION["ssUsr_UID"] = $usr->getField("PELANGGAN_BEBAS_ID");
			...
			$_SESSION["ssUsr_level"] = "Pelanggan Umum";
  ...
  $userLoginPelangganBebas = new UserLoginPelangganBebas();
