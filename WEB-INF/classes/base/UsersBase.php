  ...
  class UsersBase extends Entity{ 
    ...
    **/ 
    ...
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement="")
	{
		...
		$str = "
              SELECT USER_LOGIN_ID, USER_NAMA, USER_PASS, NAMA, ALAMAT, EMAIL, TELEPON, UNIT_UPJ, LOG_ONLINE
              (SELECT B.NAMA FROM user_group B WHERE B.USER_GROUP_ID = A.USER_GROUP_ID) USER_GROUP, USER_GROUP_ID
              FROM user_login A
              WHERE 1 = 1
				"; 
		...
		$str .= $statement." ORDER BY USER_LOGIN_ID";
