...
************************/
function createThumbnail($fileSource, $fileDestination, $newWidth = "", $newHeight = "")
{
	// Get new sizes
...
function createThumbnailBerita($fileSource, $fileDestination, $thumbMaxSize = 660, $fitSizeMode = 375)
{
	// Get new sizes
	list($width, $height) = getimagesize($fileSource);
