...
***************************************************************************************************** */
	include_once("../WEB-INF/classes/base/TingkatHukuman.php");
	include_once("../WEB-INF/classes/base/Agama.php");
	include_once("../WEB-INF/classes/base/Bank.php");
	include_once("../WEB-INF/classes/base/TipePegawai.php");
	include_once("../WEB-INF/classes/base/StatusPegawai.php");
	include_once("../WEB-INF/classes/base/JenisPegawai.php");
	include_once("../WEB-INF/classes/base/Kedudukan.php");
	include_once("../WEB-INF/classes/base/JenisHukuman.php");
	include_once("../WEB-INF/classes/base/PejabatPenetap.php");
	include_once("../WEB-INF/classes/base/Propinsi.php");
	include_once("../WEB-INF/classes/base/Kabupaten.php");
	include_once("../WEB-INF/classes/base/Kecamatan.php");
	include_once("../WEB-INF/classes/base/Kelurahan.php");
	include_once("../WEB-INF/classes/base/Pendidikan.php");
	include_once("../WEB-INF/classes/base/Diklat.php");
	include_once("../WEB-INF/classes/base/JurusanPendidikan.php");
	include_once("../WEB-INF/classes/base/Pangkat.php");
	include_once("../WEB-INF/classes/base/Eselon.php");
