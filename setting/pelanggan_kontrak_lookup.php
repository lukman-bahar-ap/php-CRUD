...
<title>IT Online Monitoring Tiket</title>
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		if(ScreenX<=494)
		{
			varColumnDefs = [{className: 'never', targets: [0]}, {className: 'none', targets: [0, -1,-2,-3]}];
			varTinggi = 130;
			varaoColumns = [
								{ bVisible:false },
							   null,
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-setting/pelanggan_kontrak_json.php",		
		...
		$('#example tbody').on( 'click', 'tr', function () {
		   ...
		   // anSelectedSatkerId = element[element.length-2];
			...
			anSelectedEmail = element[3];
			anSelectedHp = element[2];
		...
		$('#btnUbah').on('click', function () {
			  if(anSelectedData == "")
				return false;		
				window.parent.document.getElementById('reqIdPelangganKontrak').value = anSelectedId;
				window.parent.document.getElementById('reqPelangganKontrak').value = anSelectedName;
...
function Tambah(){
	...
	opUrl = 'pelanggan_kontrak_add_data.php?reqMode=insert&reqDevice='+anDevice;		
	window.parent.OpenDHTML(opUrl, 'goIT - Monitoring Tiket Keluhan', widthPopup, heightPopup, topPopup);		
}
</script> 
...
<div id="wadah">
 	 ...
 	 <div class="container">
    	<ol class="breadcrumb">
        	<li class="active">&nbsp;&nbsp;&nbsp;&nbsp;
            	<i class="clip-screen"></i>&nbsp;&nbsp;User Login
          	</li>
            <li class="active">Data Pelanggan Kontrak</li>
      	</ol>
  	</div>
    <div class="panel-heading">
      <i class="fa fa-external-link-square"></i>
          ...
          &nbsp;&nbsp;&nbsp;
          <a href="#" onClick="window.parent.divwin.close();" title="Tutup"><img src="../main/images/btn-batal.png" width="15" height="15"/> Batal</a>
    </div>
