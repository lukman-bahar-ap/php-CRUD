...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-setting/device_json.php?reqUserLoginId=<?=$reqUserLoginId?>",		
...
function Tambah(){
	...
	window.parent.OpenDHTML(opUrl, 'IT Online Monitoring Tiket', widthPopup, heightPopup, topPopup);		
}
</script> 
...
<div id="wadah">
 	 ...
 	 <div class="container">
    	<ol class="breadcrumb">
        	<li class="active">&nbsp;&nbsp;&nbsp;&nbsp;
            	<i class="clip-cog-2"></i>&nbsp;&nbsp;User Login
          	</li>
